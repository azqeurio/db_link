...
import dev.pl36.cameralink.core.deepsky.DeepSkyFrameDecision
import dev.pl36.cameralink.core.deepsky.DeepSkyFrameDecisionKind
...
import dev.pl36.cameralink.core.deepsky.DeepSkyPresetEngine
import dev.pl36.cameralink.core.deepsky.DeepSkyReferenceStatus
import dev.pl36.cameralink.core.deepsky.DeepSkyReferenceStatusSummary
import dev.pl36.cameralink.core.deepsky.FrameRegistrationMetrics
...
import dev.pl36.cameralink.core.usb.OmCaptureUsbSessionSummary
    ...
    fun `shows reference election state during warmup`() {
        val presentation = DeepSkyWorkflowPresenter.present(
            uiState = DeepSkyLiveStackUiState(
                ...
                selectedPreset = presetEngine.profile(dev.pl36.cameralink.core.deepsky.DeepSkyPresetId.WideFieldBalanced),
            ),
            omCaptureUsb = connectedUsbState(),
            tetherSaveTarget = TetherSaveTarget.SdAndPhone,
            tetherPhoneImportFormat = TetherPhoneImportFormat.JpegAndRaw,
    ...
    fun `surfaces unstable stacking and diagnostics without tutor copy`() {
        val presentation = DeepSkyWorkflowPresenter.present(
            uiState = DeepSkyLiveStackUiState(
                ...
                selectedPreset = presetEngine.profile(dev.pl36.cameralink.core.deepsky.DeepSkyPresetId.MidTeleBalanced),
            ),
            omCaptureUsb = connectedUsbState(),
            tetherSaveTarget = TetherSaveTarget.SdAndPhone,
            tetherPhoneImportFormat = TetherPhoneImportFormat.JpegAndRaw,
    ...
    fun `shows degraded performance mode when preview is throttled`() {
        val presentation = DeepSkyWorkflowPresenter.present(
            uiState = DeepSkyLiveStackUiState(
                ...
                selectedPreset = presetEngine.profile(dev.pl36.cameralink.core.deepsky.DeepSkyPresetId.LongTeleSafe),
            ),
            omCaptureUsb = connectedUsbState(),
            tetherSaveTarget = TetherSaveTarget.SdAndPhone,
            tetherPhoneImportFormat = TetherPhoneImportFormat.JpegAndRaw,
